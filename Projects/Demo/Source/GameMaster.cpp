...
void GameMasterPuppet::BindToInput( const ::std::shared_ptr<B33::App::UserInput> &pInput )
{
    ...
    pInput->Bind( &m_pGm, &m_Controller, &GameMasterController::UseActionSwitchDebugMode, nullptr, ib );

    ib.Keyboard = AbKeyboardBind { EAbOnState::Press, B33::App::AB_KEY_F1 };
    pInput->Bind( &m_pGm, &m_Controller, &GameMasterController::UseActionSetWindowMode, nullptr, ib );

    ib.Keyboard = AbKeyboardBind { EAbOnState::Press, B33::App::AB_KEY_F2 };
    pInput->Bind( &m_pGm, &m_Controller, &GameMasterController::UseActionSetBorderless, nullptr, ib );

    ib.Keyboard = AbKeyboardBind { EAbOnState::Press, B33::App::AB_KEY_ESC };
    pInput->Bind( &m_pGm, &m_Controller, &GameMasterController::UseActionExitGame, nullptr, ib );
}
